...
private slots:
    ...
    void onResponseResultUpdated(const Domain::Tests::Option::Response::Result& result);
    void onResolutionResultUpdated(const Domain::Tests::Option::Resolution::Result& result);
